...
import (
	...
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/event/definition"
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/event/notification"
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/role"
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/sidecar"
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/sidecar/collector"
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/sidecar/configuration"
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/stream"
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/stream/alarmcallback"
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/stream/alert/condition"
	streamOutput "github.com/one-2-one/terraform-provider-graylog/graylog/resource/stream/output"
	streamRule "github.com/one-2-one/terraform-provider-graylog/graylog/resource/stream/rule"
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/system/grok"
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/system/indices/indexset"
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/system/input"
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/system/input/extractor"
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/system/input/staticfield"
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/system/ldap/setting"
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/system/output"
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/system/pipeline/connection"
	"github.com/one-2-one/terraform-provider-graylog/graylog/resource/system/pipeline/pipeline"
